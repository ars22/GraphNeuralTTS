...
## Allophone changes
- Allophone is a list of tokens (compared to single string for other forms of additional info). So the data loader needed to be tweaked for accommodating a list of tokens as input (dataset.py)
