...
def split_and_save(args):
    ...
    for idx, line in enumerate(meta_all):
        ...
        if args.dataset == "arctic":
            ...
            line_id = "-".join(line.split("|")[0].split("-")[:2])
        if line_id in splits["train"]:
            ...
            raise Exception(f"Unknown split present in the splits file {line_id}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset',  type=str, help='The dataset on which to run the experiment on', required=True)
